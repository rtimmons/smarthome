  ...
  cells: [
    ...
    */
    ...
    { w:1, h:1,
      y:0, x:7-1,
      emoji: 'Briefcase',
      activeWhenRoom: 'Office',
      onPress: {action: 'ChangeRoom', args: ['Office']},
      onDoublePress: {action: 'Music.AllJoin', args: ['Office']},
    },
    { w:1, h:1,
      y:1, x:7-1,
      emoji: 'Speaker',
      togglesRoom: 'Office',
      onPress: {action: 'Music.ToggleRoom', args: ['Office']},
    },
    { w:1, h:1,
      y:0, x:8-1,
      emoji: 'Guest',
      activeWhenRoom: 'Guest Bathroom',
      onPress: {action: 'ChangeRoom', args: ['Guest Bathroom']},
      onDoublePress: {action: 'Music.AllJoin', args: ['Guest Bathroom']},
    },
    { w:1, h:1,
      y:1, x:8-1,
      emoji: 'Speaker',
      togglesRoom: 'Guest Bathroom',
      onPress: {action: 'Music.ToggleRoom', args: ['Guest Bathroom']},
    },
