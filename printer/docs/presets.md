...
- Add-on expectation: `mongodb://local-mongodb:27017/smarthome` (the service also falls back to legacy add-on hostnames; talos rewrites them to localhost for local dev runs).
